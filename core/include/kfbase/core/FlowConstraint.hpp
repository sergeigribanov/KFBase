...
namespace kfbase {
  namespace core {
    ...
    class FlowConstraint : public kfbase::newtonian_opt::EqualityLagrangeConstraint {
    public:
    ...
    private:
      ...
      kfbase::newtonian_opt::CommonParams* _beginVertex[4];
      kfbase::newtonian_opt::CommonParams* _endVertex[4];
    };
  } // namespace core
} // namespace kfbase
